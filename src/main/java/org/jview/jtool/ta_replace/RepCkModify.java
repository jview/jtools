...
public class RepCkModify extends IRep implements ITask {
	private static Logger log4 = Logger.getLogger(RepCkModify.class);
	public static int OPER_ID=4;
	public static String CODE="ckModify";
	public static String HELP_INFO="source dest 检查文件更新情况(exp:备份文件与原文件的不同)";
	@Override
...
//			dataList.add(rValue);
	...
	private  List<String> doCheck(String rValue){
		...
		List dataList=Path.checkFileModifys(sourcePath, destPath);
		return dataList;
	}
